package com.knowledgeways.idocs.ui.component.dialog.internalorganization
...
import com.knowledgeways.idocs.databinding.LayoutInternalOrganizationsBinding
...
class InternalOrganizationPicker : OrganizationAdapter.OnOrganizationClickedListener {
    ...
    fun openDialog(
        ...
        val binding = DataBindingUtil.inflate<LayoutInternalOrganizationsBinding>(
            LayoutInflater.from(context),
            R.layout.layout_internal_organizations,
            null,
            false
        )
        ...
        setOrganizationList(PreferenceManager.internalOrganization)
    ...
    companion object {
        private var instance: InternalOrganizationPicker? = null
        private val Instance: InternalOrganizationPicker
            get() {
                if (instance == null) {
                    instance = InternalOrganizationPicker()
                }
                return instance!!
            }
